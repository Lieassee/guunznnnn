...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const bioMessages = [
    "RepLover = najlepszy bot do registrow na kako",
    "Jebac Guns.lol & Fakecrime.bio, na chuj placic jak mozna zrobic wlasne",
    "C++, Html & Python dev"
  ];
  let bioText = '';
  let bioIndex = 0;
    ...
    if (!isShowingSkills) {
      gsap.to(profileBlock, {
        ...
        onComplete: () => {
          ...
          gsap.to(cppBar, { width: '62%', duration: 2, ease: 'power2.out' });
          gsap.to(csharpBar, { width: '46%', duration: 2, ease: 'power2.out' });
        }
      });
